...
best_mileage <- function(year_choice, make_choice){
  chosen_ones <- vehicles[vehicles$make == make_choice & vehicles$year == year_choice, ]
  return(chosen_ones$model[chosen_ones$hwy == max(chosen_ones$hwy)])
}

# What was the most efficient Honda model of 1995?
best_mileage(1995, "Honda")
